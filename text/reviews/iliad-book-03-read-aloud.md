...
- Restored a more ceremonial procession in the Paris–Menelaus approach by
  ...
  dismounting.
- Reduced prose-like coordination in Hector's rebuke and Paris's reply; kept
  the hostile compounds, the axe image, Aphrodite's gifts, and the proposed
  covenant.
- Reworked the truce speeches so the ritual conditions, elder counsel, lambs,
  and separate herald errands remain explicit.

## Read-aloud observations

| Passage | Observation | Action |
|---|---|---|
| 3.1–14 | The opening had too many clauses carrying equal weight. | Broke the crane flight and mist simile into breath-sized lines; retain for human stress check. |
| 3.15–37 | The former lineation rushed the recognition and dismount. | Added pauses around the leopard skin, challenge, lion simile, and leap from the chariot. |
