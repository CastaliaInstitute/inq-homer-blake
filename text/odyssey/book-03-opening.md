# *Odyssey*, Book 3 — working translation
...
- Nestor's retrospective keeps postwar memory fragmented: Telemachus hears
  an experienced witness, not a complete omniscient account of the return.
- The hospitality scenes preserve the poem's ritual order—sacrifice, food,
  washing, gifts, sleep, and renewed departure—as a moral architecture.
- Helen's drug and stories remain ethically double-edged: consolation and
  self-fashioning coexist without a modern explanatory gloss.
- This draft needs Greek-fidelity review for the return catalogue, the
  sacrificial procedure, Helen's drug, Proteus's report, and the gift sequence.
