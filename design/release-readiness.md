...
| Oral prosody | HOLD | 7,472/12,733 *Iliad* lines (58.7%) and 6,058/8,630 *Odyssey* lines (70.2%) fall in the heuristic 8–12-syllable band; 7,833 outliers remain unreviewed. |
...
2. Obtain named signoff for all 288 editorial gate cells and resolve/document
   the 7,833 meter-screen outliers through human read-aloud review.
