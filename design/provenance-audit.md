...
The Apollo and Athena plates are CastaliaInstitute concept candidates. They
are original generated work, not William Blake works and not transformations of
a specific Blake plate. Each record retains its prompt file, date, dimensions,
curation status, and explicit credit. The v2 candidates are 2100 × 3000 px
(approximately 300 dpi at 7 × 10 inches), but remain `concept-review` until a
print master, color profile, and human art-direction approval are recorded.
