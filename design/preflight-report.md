...
|---|---:|---|---|
| Iliad interior proof | 384 | 477 x 738 pts | no |
| Odyssey interior proof | 275 | 477 x 738 pts | no |
...
- Reader-facing density screen: 0 provisional holds; see `design/translation-density-report.md`.
- Architecture page map: 659 traced pages.
