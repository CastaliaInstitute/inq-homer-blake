...
story += [Spacer(1, 0.22 * inch), Paragraph("Working draft: Odyssey 1.1-21. Greek base text: A. T. Murray, The Odyssey (1919), Perseus CTS grc1. Not approved for final layout.", styles["ODCaption"]), NextPageTemplate("full"), PageBreak()]
...
story += [Paragraph("PROOF NOTES", styles["ODHead"]), Paragraph("This four-page proof tests the shared page architecture for the Odyssey volume: title page, verse page, full-page plate, and caption treatment. The plate is original work and is not credited to William Blake. Before production approval, lock the typeface licenses and print profile, expand the page map, and complete the six translation review gates.", styles["ODSmall"]), Spacer(1, 0.3 * inch), Paragraph("Preflight status", styles["ODHead"]), Paragraph("TEXT: draft / ART: concept-review / LAYOUT: sample proof / RELEASE: not ready", styles["ODSmall"])]
doc.build(story)
print(OUT)
