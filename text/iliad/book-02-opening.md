...
- The false dream remains explicitly false: Zeus's promise is not made a
  reliable report simply because Agamemnon believes it.
- The assembly moves through three registers—rumor, royal command, and the
  common soldier's disorder—before Odysseus restores a speaking order.
- “Scepter” remains concrete and ceremonial; its repeated transfer marks the
  difference between rank, persuasion, and coercion.
- This draft needs Greek-fidelity review for the dream's imperative language,
  the bee simile, the assembly geography, and the characterization of
  Thersites before it can advance beyond `draft`.
