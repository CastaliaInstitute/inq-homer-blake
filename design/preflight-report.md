...
| Odyssey interior proof | 235 | 477 x 738 pts | no |
...
- Reader-facing density screen: 8 provisional holds; see `design/translation-density-report.md`.
- Architecture page map: 585 traced pages.
