...
This opening cadence pass gives the aristeia a processional entrance while
keeping the Greek's physical sequence and its compact household tragedy. Greek-
fidelity review, stress analysis, complete-book read-aloud, and human sign-off
remain pending.

| Passage | Observation | Action |
|---|---|---|
...
| 5.297–342 | Aeneas' lion-like defense and Aphrodite's intervention need to separate mortal force, maternal rescue, and the first wound to an immortal. | Preserved the hip/socket injury, black night, Aphrodite's robe-shield, Apollo's dark-cloud rescue of Aeneas, Sthenelus' horse seizure, Deipylus, the Graces' robe, and the flow of ichor. |
| 5.343–360 | Aphrodite's flight must retain the battlefield handoff rather than making her appear to summon the horses herself. | Restored Diomedes' taunt, Iris' extraction, Ares seated at the battle's left, Aphrodite's plea, the golden-maned team, and Iris' reins before the Olympus journey. |
| 5.361–389 | The Olympus arrival and Dione's consolation should preserve both ritual texture and the personal threat to Diomedes' home. | Preserved the unharnessing, ambrosial food, Dione's embrace, the Aloadae and Hermes, Hera and Heracles, Hades and Heracles, Paeon's medicine, and Aegialeia's threatened lament. |
| 5.390–460 | The divine exempla and Athena's teasing exchange must keep mortal-divine boundaries distinct before Apollo intervenes. | Re-lineated each wound, captor or archer, Athena's agency, the golden brooch joke, Zeus' reply, the three charges, Pergamus, the image-double, and Apollo's handoff to Ares. |
...
| 5.561–600 | Menelaus and Antilochus must move from pity to recovery, then into a precise paired attack as Hector and Ares reverse the momentum. | Preserved Menelaus' pity, Ares' intention that he fall beneath Aeneas' hands, the rescue of the dead, Pylæmenes, Mydon's reins and elbow, Hector's approach, Enyo's shameless war-tumult, and Diomedes' river-flood warning. |
...
| 5.699–777 | Hector's pressure, the catalog of Argive losses, and Hera's return to battle must move from defeat into ceremonial preparation. | Preserved Sarpedon's plea, Pelagon's extraction, the six named Argive deaths, the golden chariot, Hera's exchange with Zeus, the earth-to-heaven travel simile, Athena's aegis and helmet, and the Simoeis–Scamander landing. |
...
The Verse gate remains **pending**. The machine screen is a syllable-band
heuristic and does not certify natural five-stress movement.
