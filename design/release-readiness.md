...
| BookVault prepress interiors | `output/pdf/inq-homer-*-bookvault-interior.pdf`; `scripts/validate_bookvault_interiors.py` | Iliad 320 pages and Odyssey 222 pages retain exact 168 × 260 mm TrimBox geometry, but both are stale after manuscript/export corrections. Source-hash validation fails until they are rebuilt; release approval remains pending. |
