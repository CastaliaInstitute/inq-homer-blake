...
|---|---:|---|---|
| *Iliad* | 24 | 1.1 through 24.804 covered; interval audit passed | Books 1–10 and 19–24 are `review`; Books 11–18 are `draft`; gates pending |
| *Odyssey* | 24 | 1.1 through 24.548 covered; interval audit passed | Books 1–10 and 19–24 are `review`; Books 11–18 are `draft`; gates pending |
