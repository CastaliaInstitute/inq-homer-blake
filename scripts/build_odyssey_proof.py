...
story += [Spacer(1, 0.22 * inch), Paragraph("Working draft: Odyssey 1.1-50. Greek base text: D. B. Monro and T. W. Allen, Homeri Opera (Oxford, 1920), Perseus tlg0012.tlg002.perseus-grc2, pinned in text/source-lock.md. Not approved for final layout.", styles["ODCaption"]), NextPageTemplate("full"), PageBreak()]
