# *Odyssey*, Book 11 — working translation
...
- The underworld is rendered as a threshold governed by procedure: trench,
  offerings, blood, and permission determine who may speak and be heard.
- Elpenor's request joins burial, memory, and the practical object of the oar;
  the dead demand a future act from the living.
- Anticleia's failed embrace preserves the difference between body and shade
  without making grief abstract or philosophical.
- The women, punishments, and Heracles are treated as a sequence of visions
  whose order and names require careful collation, not as a loose mythology.
- This draft needs Greek-fidelity review for ritual directions, Tiresias'
  prophecy, all underworld figures, Heracles' status, and the ending.
