...
| Historical architecture proofs | `output/pdf/inq-homer-iliad-volume-proof.pdf`, `output/pdf/inq-homer-odyssey-volume-proof.pdf` | Current comic-size development proofs at 477 × 738 pt; final locked-text exports pending. The current Odyssey proof has 280 pages. |
