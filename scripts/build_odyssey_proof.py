...
story += [Spacer(1, 0.22 * inch), Paragraph("Working draft: Odyssey 1.1-21. Greek base text: T. W. Allen, Homeri Opera. Not approved for final layout.", styles["ODCaption"]), PageBreak()]
