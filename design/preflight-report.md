...
| Odyssey interior proof | 177 | 477 x 738 pts | no |
...
- Reader-facing density screen: 16 provisional holds; see `design/translation-density-report.md`.
- Architecture page map: 527 traced pages.
