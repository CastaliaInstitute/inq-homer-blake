...
| Oral prosody | HOLD | 7,454/12,727 *Iliad* lines (58.6%) and 6,058/8,633 *Odyssey* lines (70.2%) fall in the heuristic 8–12-syllable band; 7,848 outliers remain unreviewed. |
...
2. Obtain named signoff for all 288 editorial gate cells and resolve/document
   the 7,848 meter-screen outliers through human read-aloud review.
